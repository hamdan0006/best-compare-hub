...
function FreeForLife() {
 ...
 // Filtered Cards based on Search, Filters, and AirportService
 const filteredCards = cards.filter((card) => {
    ...
    const hasAirportService = card.AirportService === true;
    const isFreeForLife = card.FreeForLife === true; // Check if FreeForLife is true
    ...
    return (
      ...
      isSalaryMatch &&
      hasAirportService &&
      isFreeForLife // Include this in the filter
    );
  });
