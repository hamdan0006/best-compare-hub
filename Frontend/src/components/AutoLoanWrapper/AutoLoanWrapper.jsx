...
function AutoLoanWrapper() {
  ...
  const mortgages = [
    {
      ...
      minSalary: '5,000',
      fixedRate: '3.24%',
      applyLink: `/auto-loan/apply-now?bankName=${encodeURIComponent('Abu-Dhabi-Bank-FAB')}`,
    },
    {
      ...
      minSalary: '5,000',
      fixedRate: '3.19%',
      applyLink: `/auto-loan/apply-now?bankName=${encodeURIComponent('Emirates-NBD')}`,
    },
    {
      ...
      minSalary: '5,000',
      fixedRate: '3.19%',
      applyLink: `/auto-loan/apply-now?bankName=${encodeURIComponent('Abu-Dhabi-Commercial-Bank')}`,
    },
    {
      ...
      minSalary: '5,000',
      fixedRate: '3.39%',
      applyLink: `/auto-loan/apply-now?bankName=${encodeURIComponent('Dubai-Islamic-Bank')}`,
    },
    {
      ...
      minSalary: '5,000',
      fixedRate: '3.75%',
      applyLink: `/auto-loan/apply-now?bankName=${encodeURIComponent('Sharjah-Islamic-Bank')}`,
    },
    {
      ...
      minSalary: '5,000',
      fixedRate: '4.0%',
      applyLink: `/auto-loan/apply-now?bankName=${encodeURIComponent('Bank-of-Sharjah')}`,
    },
    {
      ...
      minSalary: '5,000',
      fixedRate: '4.25%',
      applyLink: `/auto-loan/apply-now?bankName=${encodeURIComponent('National-Bank-of-Fujairah')}`,
    },
    {
      ...
      minSalary: '5,000',
      fixedRate: '4.25%',
      applyLink: `/auto-loan/apply-now?bankName=${encodeURIComponent('United-Arab-Bank')}`,
    },
    {
      ...
      minSalary: '5,000',
      fixedRate: '3.75%',
      applyLink: `/auto-loan/apply-now?bankName=${encodeURIComponent('Commercial-Bank-of-Dubai')}`,
    },
    {
      ...
      minSalary: '5,000',
      fixedRate: '4.5%',
      applyLink: `/auto-loan/apply-now?bankName=${encodeURIComponent('Al-Masraf-(Arab-Bank-for-Investment-&-Foreign-Trade)')}`,
    },
    {
      bankName: 'Ajman Bank',
      ...
      minSalary: '5,000',
      fixedRate: '4.25%',
      applyLink: `/auto-loan/apply-now?bankName=${encodeURIComponent('Ajman-Bank')}`,
    },
    {
      ...
      minSalary: '5,000',
      fixedRate: '3.99%',
      applyLink: `/auto-loan/apply-now?bankName=${encodeURIComponent('Al-Hilal-Bank')}`,
    },
  ];

  // Filtered mortgages based on search query
  ...
  return (
    <>
      <CommonHero heading="Auto Loan" backgroundImage={backgroundImage} />
...
export default AutoLoanWrapper;